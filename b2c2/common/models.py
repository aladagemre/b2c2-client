...
class RFQRequest(BaseModel):
    # Instrument name as given by the /instruments/ endpoint.
    instrument: str
    # Either ‘buy’ or ‘sell’.
    side: Side
    # Quantity in base currency (maximum 4 decimals).
    quantity: Decimal
    # uuid4 identifier that will be returned to you if the request succeeds.
    client_rfq_id: str


class RFQResponse(BaseModel):
    # This RFQ is valid until this datetime.
    valid_until: datetime.datetime
    # uuid generated by the API.
    rfq_id: str
    # uuid4 identifier that will be returned to you if the request succeeds.
    client_rfq_id: str
    # Quantity in base currency (maximum 4 decimals).
